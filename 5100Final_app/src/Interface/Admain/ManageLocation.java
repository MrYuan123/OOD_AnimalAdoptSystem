...
public class ManageLocation extends javax.swing.JPanel {
    ...
    public ManageLocation(JPanel rightpanel, EcoSystem ecoSystem) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Interface/Admain/adminPage.png"))); // NOI18N
    ...
    private void CreateBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CreateBtnActionPerformed
        ...
        {
            Network network = ecoSystem.getNetworkDir().createNetwork();
